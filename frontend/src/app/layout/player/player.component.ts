...
export class PlayerComponent {
	...
	private nextQueue: Array<SongContent> = []; //boutton après
	private previousQueue: Array<SongContent> = []; //boutton avant
	...
	constructor() {
		...
		effect(() => {
			//quand il y'a une nouvelle chanson à passer en lecture
